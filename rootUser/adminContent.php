    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-1">
                <button class="btn btn-success mb-1" data-toggle="modal" data-target="#create"><i>добавить</i></button>
                <button data-toggle="modal" data-target="#createe" type="button" class="btn btn " style="color: steelblue; position:absolute; right:15px; top:0px;">
                    <a href="/rootUser/logout.php">Выйти</a></button>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $item[3] ?></td>
                                <td>
                                    <a href="/rootUser/updateForm.php?id=<?= $item[0] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                    <a href="../rootUser/crud/delete.php?id=<?= $item[0] ?>" class="btn btn-danger btn-sm" data-target="#deleteModal"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content shadow">
                ...
                <div class="modal-body">
                    <form action="/rootUser/crud/create.php" method="post">
