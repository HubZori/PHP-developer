...
<body>
	<div class="container">
		<div class="row">
			<div class="col mt-1">
				<?=$success ?>
				<button class="btn btn-success mb-1" data-toggle="modal" data-target="#Modal"><i>оставить заявку</i></button>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
	        	...
	        	<div class="form-group">
	        		<input type="number" class="form-control" name="last_name" value="" placeholder="Phone">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="pos" value="" placeholder="User name">
	        	</div>
	      </div>
